...
pub struct NflPlayer {
    ...
    sportradar_id: Option<String>, // UUID
    search_first_name: Option<String>,
    practice_description: Option<String>,
    injury_body_part: Option<String>,
    ...
    age: Option<u8>,
    pandascore_id: Option<String>,
    sport: String,
    practice_participation: Option<String>,
    weight: Option<String>,
    swish_id: Option<u32>,
    depth_chart_order: Option<u8>,
    years_exp: Option<i8>,
    college: Option<String>,
    news_updated: Option<u64>,
    rotoworld_id: Option<u64>,
    last_name: String,
    birth_state: Option<String>,
    fantasy_positions: Option<Vec<String>>,
    birth_country: Option<String>,
    search_full_name: Option<String>,
    stats_id: Option<u32>,
    gsis_id: Option<String>,
    depth_chart_position: Option<String>,
    full_name: Option<String>,
    rotowire_id: Option<u32>,
    espn_id: Option<u64>,
    fantasy_data_id: Option<u64>,
    active: bool,
    number: Option<u8>,
    player_id: PlayerId,
    hashtag: Option<String>,
    search_last_name: Option<String>,
